...
export {
  ...
  type PerformanceHistoryQueryInputV2,
  type PerformanceHistoryQueryResult,
  type PerformanceHistoryQueryResultV2,
  type PerformanceSeries,
  type ComparableProfileSeriesV2,
  type EpisodePerformance,
  type QueryExcludedEpisode,
  type RoleExecutionAggregations,
