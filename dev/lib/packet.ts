...
/**
 * O packet contém SOMENTE o que o plano declara. Nada de transcript, conversa,
 * raciocínio, logs ou reviews históricos — a limpeza de contexto é garantida
 * pelo processo novo, e o packet é o único canal de entrada permitido.
 */
